...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <hr>
      This app can optionally protect the clients of all ages by filtering out the profiles with NSFW images using third-party service: [DeepaAI](https://deepai.org/)
      <hr>
